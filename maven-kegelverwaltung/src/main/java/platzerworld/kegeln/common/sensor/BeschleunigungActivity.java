...
/**
 * BeschleunigungActivity
 * 
 * @author platzerg
 */
public class BeschleunigungActivity extends Activity implements SensorListener, OnClickListener {
	...
	protected void onResume() {
		...
		if (!accelSupported) {
			...
			sensorMgr.unregisterListener(this, SENSOR_ACCELEROMETER);
			accuracyLabel.setText("no_accelerometer");
		}
	}
	...
	public void onAccuracyChanged(int sensor, int accuracy) {
		...
		if (sensor == SENSOR_ACCELEROMETER) {
			...
			case SENSOR_STATUS_UNRELIABLE:
				accuracyLabel.setText("accuracy_unreliable");
				break;
			case SENSOR_STATUS_ACCURACY_LOW:
				accuracyLabel.setText("accuracy_low");
				break;
			case SENSOR_STATUS_ACCURACY_MEDIUM:
				accuracyLabel.setText("accuracy_medium");
				break;
			case SENSOR_STATUS_ACCURACY_HIGH:
				accuracyLabel.setText("accuracy_high");
				break;
			}
		}
	}
