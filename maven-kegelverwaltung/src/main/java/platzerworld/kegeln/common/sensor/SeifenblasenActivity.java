...
/**
 * SeifenblasenActivity
 * 
 * @author platzerg
 */
public class SeifenblasenActivity extends Activity implements Callback, OnTouchListener {
	private SurfaceView surface;
	private SurfaceHolder holder;
	private final SeifenblasenModel model = new SeifenblasenModel();
	...
	private void doDraw(Canvas c) {
		...
		List<SeifenblasenModel.Bubble> bubbles = model.getBubbles();
		for (SeifenblasenModel.Bubble bubble : bubbles) {
