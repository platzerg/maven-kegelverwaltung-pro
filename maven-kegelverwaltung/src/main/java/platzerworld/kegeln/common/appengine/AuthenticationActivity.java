...
public class AuthenticationActivity extends Activity {
	...
	/**
	 * Application Url: z.B. kegelverwaltung.appspot.com
	 */
	 ...
	 */
	private KegelverwaltungAppEngine mAEInstance;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAEInstance = KegelverwaltungAppEngine.createInstance(mApplicationUrl);
